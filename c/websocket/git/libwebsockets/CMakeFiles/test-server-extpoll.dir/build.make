...
CMakeFiles/test-server-extpoll.dir/test-server/test-server.c.o: test-server/test-server.c
	...
	/usr/bin/cc  $(C_DEFINES) $(C_FLAGS) -o CMakeFiles/test-server-extpoll.dir/test-server/test-server.c.o   -c /data/mysocket/c/websocket/git/libwebsockets/test-server/test-server.c
...
CMakeFiles/test-server-extpoll.dir/test-server/test-server.c.i: cmake_force
	...
	/usr/bin/cc  $(C_DEFINES) $(C_FLAGS) -E /data/mysocket/c/websocket/git/libwebsockets/test-server/test-server.c > CMakeFiles/test-server-extpoll.dir/test-server/test-server.c.i
...
CMakeFiles/test-server-extpoll.dir/test-server/test-server.c.s: cmake_force
	...
	/usr/bin/cc  $(C_DEFINES) $(C_FLAGS) -S /data/mysocket/c/websocket/git/libwebsockets/test-server/test-server.c -o CMakeFiles/test-server-extpoll.dir/test-server/test-server.c.s
...
CMakeFiles/test-server-extpoll.dir/depend:
	cd /data/mysocket/c/websocket/git/libwebsockets && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /data/mysocket/c/websocket/git/libwebsockets /data/mysocket/c/websocket/git/libwebsockets /data/mysocket/c/websocket/git/libwebsockets /data/mysocket/c/websocket/git/libwebsockets /data/mysocket/c/websocket/git/libwebsockets/CMakeFiles/test-server-extpoll.dir/DependInfo.cmake --color=$(COLOR)
